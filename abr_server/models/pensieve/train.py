...
from models.pensieve.A3C import A3C
...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './results/pensieve/model/'
LOG_FILE = './logs/pensieve'
TEST_LOG_FOLDER = './logs/'
TRAIN_TRACES = './datasets/network_trace/pensieve_traces/cooked_traces/'
...
def testing(epoch, actor_model,log_file):
    ...
    # run test script
    os.system('python3 -m models.pensieve.test')
...
def central_agent(net_params_queues, exp_queues, model_type):
    ...
    for epoch in range(TOTALEPOCH):
        ...
        if (epoch+1) % MODEL_SAVE_INTERVAL == 0:
            ...
            print("Train ep:"+str(epoch+1)+",time use: "+str((datetime.now()-timenow).seconds)+"s, " + f"Avg_reward: {avg_reward}")
            timenow=datetime.now()
